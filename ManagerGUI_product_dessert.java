...
public class ManagerGUI_product_dessert extends JFrame implements ItemListener, ActionListener {
    ...
    // restaurant name
    private String PAGE_NAME = "Desserts";
    // Entree container
    ...
    // default initializer
    public ManagerGUI_product_dessert(Connection con) {
        this.conn = con;
        ...
        // e1 
        e1 = new JPanel();
        change = new JLabel("Vanilla Milk Shake: Change ");
        ...
        // e2 
        e2 = new JPanel();
        change = new JLabel("Ice Cream: Change ");
        ...
        // e3 
        e3 = new JPanel();
        change = new JLabel("Apple Pie: Change ");
        ...
        // e4
        e4 = new JPanel();
        change = new JLabel("Chocolate Chip Cookie: Change ");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == b1) { 
            if(Price_e1){
                ...
                update_price(17,Float.parseFloat(text1));
            ...
            if(Price_e2){
                ...
                update_price(18,Float.parseFloat(text2));
           ...
           if(Price_e3){
                ...
                update_price(19,Float.parseFloat(text3));
           ...
           if(Price_e4){
                ...
                update_price(20,Float.parseFloat(text4));
